...
import {blogInputValidator, idParamValidator, blogQueryValidator} from "./validators/blogValidators"
...
blogsRouter.get('/', blogQueryValidator, inputCheckErrorsMiddleware, getBlogsController)
