...
import {BlogQueryParamsType, InputBlogType, OutputBlogType} from "../../../input-output-types/blog-types"
...
export const blogMongoRepository = {
    ...
    async findAllForOutput(queryParams: BlogQueryParamsType): Promise<OutputBlogType[]> {
